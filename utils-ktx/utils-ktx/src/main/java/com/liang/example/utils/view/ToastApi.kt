...
@JvmOverloads
fun showToast(msg: String, c: Context? = ApiManager.CONTEXT.app, duration: Int = Toast.LENGTH_SHORT) {
    if (c != null) Toast.makeText(c, msg, duration).show()
}

@JvmOverloads
fun showToastOrLog(msg: String, c: Context? = ApiManager.CONTEXT.app, duration: Int = Toast.LENGTH_SHORT) {
    if (c != null) Toast.makeText(c, msg, duration).show() else ApiManager.LOGGER.d(ApiManager.DEFAULT_TAG, msg)
}

@JvmOverloads
fun showToastWithLog(msg: String, c: Context? = ApiManager.CONTEXT.app, duration: Int = Toast.LENGTH_SHORT) {
    if (c != null) Toast.makeText(c, msg, duration).show()
...
@JvmOverloads
fun showSnackbarWithAction(msg: String, a: Activity, text: String, duration: Int = Snackbar.LENGTH_SHORT, log: Boolean = false, listener: ((v: View) -> Unit)) {
...
@JvmOverloads
fun showSnackbarWithAction(msg: String, v: View, text: String, duration: Int = Snackbar.LENGTH_SHORT, log: Boolean = false, listener: ((v: View) -> Unit)) {
