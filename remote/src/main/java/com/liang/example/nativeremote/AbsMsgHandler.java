...
public abstract class AbsMsgHandler<Req, Res> {
    ...
    public AbsMsgHandler(String reqTypeStr, String resTypeStr) {
    ...
    public AbsMsgHandler(String reqTypeStr, String resTypeStr, Class<Req> reqType, Class<Res> resType) {
        this.reqTypeStr = reqTypeStr;
        this.resTypeStr = resTypeStr;
