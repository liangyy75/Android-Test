...
class FormatAndroidLogLogger(override var logLevel: LoggerLevel = DEFAULT_LEVEL) : NamedLoggerInter {
     ...
     * 2 -- LoggerFormatter.kt/79 liang.example.utils.logger.AndroidLoggerFormatter/formatMsg
     * 3 -- Logger.kt/429 liang.example.utils.logger.FormatAndroidLogLogger/d
     * 4 -- Logger.kt/237 liang.example.utils.logger.MultiLogger/d
     * 5 -- Logger.kt/39 liang.example.utils.logger.LoggerInter$DefaultImpls/d
     * 6 -- Logger.kt/217 liang.example.utils.logger.MultiLogger/d
     * 7 -- ...
     */
    private inline fun log(tag: String, msg: String, t: Throwable?, method1: (String, String) -> Int,
                           method2: (String, String, Throwable) -> Int, level: LoggerLevel, vararg args: Any?): Int {
