...
class Constants {
    ...
    static final Class<?>[] classes = new Class<?>[]{
            ...
            com.liang.example.rxjavatest.MainActivity.class,
            com.liang.example.javaandroidtest.MainActivity.class,
    };
    ...
    static final String[] descs = new String[]{
            ...
            "Some tests about RxJava",
            "一些关于Groovy/Java/Kotlin混编的测试"
    };
